	    ...
	    Mat *m						)														//融合区 Mark
{
    ...
    Generate_Equirectangular_src_0_map_roi(src_size, EQ_IMAG_SIZE, center_all_1, rad_all_1, RotationMatrix, TMatrix, pdK, mapx_roi0, mapy_roi0);
	//imag_1 经纬展开 ROI 融合区 map
    Generate_Equirectangular_src_1_map_roi(src_size, EQ_IMAG_SIZE, center_all_2, rad_all_2, mapx_roi1, mapy_roi1);
