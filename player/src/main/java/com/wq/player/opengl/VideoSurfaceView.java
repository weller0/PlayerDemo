...
public class VideoSurfaceView extends GLSurfaceView {
    ...
    public VideoSurfaceView(Context context, boolean isUseBitmap, boolean isLeft, int sm, int cs, int rr) {
        super(context);
        init(isUseBitmap, isLeft, sm, cs, rr);
    }
    ...
    private void init(boolean isUseBitmap, boolean isLeft, int sm, int cs, int rr) {
        ...
        mSettingsBean.setUseBitmap(isUseBitmap);
        mSettingsBean.setLeft(isLeft);
    ...
    public void setMode(int sm, int rr, int cs){
        if(sm > SettingsBean.SM_NULL && sm < SettingsBean.SM_MAX) {
            mSettingsBean.setShowMode(sm);
        }
        if(rr > SettingsBean.RR_NULL && rr < SettingsBean.RR_MAX) {
            mSettingsBean.setResolutionRatio(rr);
        }
        if(cs > SettingsBean.CS_NULL && cs < SettingsBean.CS_MAX) {
            mSettingsBean.setCtrlStyle(cs);
        }
